...
var AdvancedURI = /** @class */ (function (_super) {
    ...
    AdvancedURI.prototype.handleSearch = function (parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var view, search;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.open({ file: parameters.filepath, parameters: parameters })];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    AdvancedURI.prototype.handleCopyFileURI = function (withoutData, file) {
        var _this = this;
        var view = this.app.workspace.getActiveViewOfType(obsidian.FileView);
        if (!view && !file)
            return;
