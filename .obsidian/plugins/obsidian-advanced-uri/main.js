            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6:
                        if (!(parameters.mode != undefined)) return [3 /*break*/, 8];
...
var AdvancedURI = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        if (parameters.openmode == "silent")
                            return [2 /*return*/];
                        if (!this.settings.openFileOnWrite) return [3 /*break*/, 2];
    ...
    AdvancedURI.prototype.open = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var hoverEditor, leaf_1, tfile, openMode, fileIsAlreadyOpened_1, leaf, viewState;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(parameters.openmode == "popover" && (supportPopover !== null && supportPopover !== void 0 ? supportPopover : true))) return [3 /*break*/, 1];
                    ...
                    case 1:
                        ...
                        if (!isBoolean(openMode)) return [3 /*break*/, 4];
                        ...
                        if (!(fileIsAlreadyOpened_1 && parameters.viewmode != undefined)) return [3 /*break*/, 3];
                    ...
                    case 3:
                        if (fileIsAlreadyOpened_1)
                            return [2 /*return*/];
                        _b.label = 4;
                    case 4: return [2 /*return*/, this.app.workspace.openLinkText(file instanceof obsidian.TFile ? file.path : file, "/", openMode, mode != undefined
                            ? { state: { mode: mode } }
