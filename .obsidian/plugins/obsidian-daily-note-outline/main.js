...
function createAndOpenDailyNote(date, allFiles) {
  return __async(this, null, function* () {
    const { workspace } = window.app;
    const createFile = () => __async(this, null, function* () {
      const newNote = yield (0, import_obsidian_daily_notes_interface.createDailyNote)(date);
      yield workspace.getLeaf().openFile(newNote);
    });
    const dailynote = (0, import_obsidian_daily_notes_interface.getDailyNote)(date, allFiles);
    if (!dailynote) {
      yield createFile();
    } else {
...
var DailyNoteOutlineView = class extends import_obsidian3.ItemView {
  ...
  onOpen() {
    return __async(this, null, function* () {
      this.initView();
      const debouncerRequestRefresh = (0, import_obsidian2.debounce)(this.autoRefresh, 2e3, true);
    ...
    return __async(this, null, function* () {
      ...
      if (this.settings.initialSearchType == "forward") {
        ...
        if (onsetDate.isValid()) {
          ...
          new import_obsidian2.Notice("onset date is invalid");
          this.searchRange = {
  ...
  refreshView(regetAll, getTarget, getOutline) {
    return __async(this, null, function* () {
      if (regetAll) {
        this.allDailyNotes = (0, import_obsidian_daily_notes_interface2.getAllDailyNotes)();
      }
      if (getTarget) {
  ...
  getFileInfo(files) {
    return __async(this, null, function* () {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        const info = {
          date: (0, import_obsidian_daily_notes_interface2.getDateFromFile)(files[i], "day"),
          lines,
  ...
  drawUI() {
    ...
    (0, import_obsidian2.setIcon)(navActionButton, "arrow-left", 20);
    ...
    (0, import_obsidian2.setIcon)(navActionButton, "arrow-right", 20);
    navActionButton.addEventListener("click", (event) => __async(this, null, function* () {
      event.preventDefault();
    ...
    (0, import_obsidian2.setIcon)(navActionButton, "home", 20);
    navActionButton.addEventListener("click", (event) => __async(this, null, function* () {
      event.preventDefault();
      if (this.settings.initialSearchType == "forward") {
        const onsetDate = (0, import_moment.default)(this.settings.onset, "YYYY-MM-DD");
    ...
    (0, import_obsidian2.setIcon)(navActionButton, "refresh-cw", 20);
    navActionButton.addEventListener("click", (event) => __async(this, null, function* () {
      event.preventDefault();
      if (this.settings.initialSearchType == "forward") {
        const onsetDate = (0, import_moment.default)(this.settings.onset, "YYYY-MM-DD");
    ...
    (0, import_obsidian2.setIcon)(navActionButton, "settings", 20);
    navActionButton.addEventListener("click", (event) => __async(this, null, function* () {
    ...
    (0, import_obsidian2.setIcon)(navActionButton, "calendar-plus", 20);
    navActionButton.addEventListener("click", (event) => __async(this, null, function* () {
      event.preventDefault;
    ...
    navActionButton.addEventListener("contextmenu", (event) => {
      ...
      menu.addItem((item) => item.setTitle("create/open tomorrow's daily note").setIcon("calendar-plus").onClick(() => __async(this, null, function* () {
        const date = (0, import_moment.default)().add(1, "days");
        createAndOpenDailyNote(date, this.allDailyNotes);
      })));
    ...
    if (!this.extractMode) {
      ...
      (0, import_obsidian2.setIcon)(navActionButton, "search", 20);
      navActionButton.addEventListener("click", (event) => __async(this, null, function* () {
        event.preventDefault;
      ...
      (0, import_obsidian2.setIcon)(navActionButton, "x-circle", 20);
      navActionButton.addEventListener("click", (event) => __async(this, null, function* () {
        this.extractMode = false;
        this.extractTask = false;
        this.refreshView(false, false, false);
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      switch (this.settings.icon.note) {
        case "none":
          break;
        case "custom":
          (0, import_obsidian2.setIcon)(dailyNoteTitleEl, this.settings.customIcon.note);
          break;
        default:
          if (this.settings.icon.note) {
            (0, import_obsidian2.setIcon)(dailyNoteTitleEl, this.settings.icon.note);
          }
          break;
      }
          ...
          for (let j = 0; j < data[i].length; j++) {
            ...
            switch (this.settings.icon[element]) {
              ...
              case "headingwithnumber":
                (0, import_obsidian2.setIcon)(outlineTitle, `heading-${data[i][j].level}`);
                break;
              case "custom":
                (0, import_obsidian2.setIcon)(outlineTitle, this.settings.customIcon[element]);
                break;
              default:
                (0, import_obsidian2.setIcon)(outlineTitle, this.settings.icon[element]);
                break;
            }
            if (element == "listItems" && data[i][j].task !== void 0) {
              if (data[i][j].task == "x") {
                (0, import_obsidian2.setIcon)(outlineTitle, this.settings.icon.taskDone == "custom" ? this.settings.customIcon.taskDone : this.settings.icon.taskDone);
              } else {
                (0, import_obsidian2.setIcon)(outlineTitle, this.settings.icon.task == "custom" ? this.settings.customIcon.task : this.settings.icon.task);
              }
            }
            ...
            outlineTitle.addEventListener("contextmenu", (event) => {
              ...
              menu.addItem((item) => item.setTitle("Open in new window").setIcon("box-select").onClick(() => __async(this, null, function* () {
...
var DailyNoteOutlineSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName("Initial search type").setDesc("search backward from today / forward from a specific date").addDropdown((dropdown) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Search duration").setDesc("number of days to search per page (default = 28)").addText((text) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Include future daily notes").setClass("setting-indent").setDesc("in backward search, include n days of future daily notes (default = 5)").addText((text) => {
      text.inputEl.setAttr("type", "number");
    ...
    new import_obsidian4.Setting(containerEl).setName("Onset date").setClass("setting-indent").setDesc("onset date in forward search (YYYY-MM-DD)").addText((text) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Show headings").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Show links").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Show tags").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Show list items & tasks").addToggle((toggle) => {
    ...
    if (this.plugin.settings.showElements.listItems) {
      new import_obsidian4.Setting(containerEl).setName("Show all root list items").setDesc("if disabled, only top item of the list is displayed").setClass("setting-indent").addToggle((toggle) => {
      ...
      new import_obsidian4.Setting(containerEl).setName("Show all tasks").setDesc("show all task items regardless of their level").setClass("setting-indent").addToggle((toggle) => {
      ...
      new import_obsidian4.Setting(containerEl).setName("Task only").setDesc("if enabled, normal list items are hidden").setClass("setting-indent").addToggle((toggle) => {
      ...
      new import_obsidian4.Setting(containerEl).setName("Hide completed tasks").setClass("setting-indent").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Display file information").setDesc("display the number of lines of the file / days from the base date with the file name").addDropdown((dropdown) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Position of the plugin view").setDesc("Specify default position where this plugin's view appears").addDropdown((dropdown) => {
    ...
    if (this.plugin.settings.showElements.heading) {
      ...
      this.plugin.settings.headingLevel.forEach((value, index, arry) => {
        new import_obsidian4.Setting(containerEl).setName(`Level${index + 1}`).setClass("setting-indent").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Inline preview").setDesc("Show a few subsequent words next to the outline element name").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Tooltip preview").setDesc("Show subsequent sentences as a tooltip when hover").addToggle((toggle) => {
    ...
    if (this.plugin.settings.tooltipPreview) {
      new import_obsidian4.Setting(containerEl).setName("Tooltip preview direction").setClass("setting-indent").setDesc("specify the direction to display tooltip preview").addDropdown((dropdown) => {
    ...
    if (this.plugin.settings.showElements.heading) {
      new import_obsidian4.Setting(containerEl).setName("Headings to ignore").setDesc("Headings which include listed words will not be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    if (this.plugin.settings.showElements.link) {
      new import_obsidian4.Setting(containerEl).setName("Links to ignore").setDesc("Links which include listed words will not be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    if (this.plugin.settings.showElements.tag) {
      new import_obsidian4.Setting(containerEl).setName("Tags to ignore").setDesc("tags which include listed words will not be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    if (this.plugin.settings.showElements.listItems) {
      new import_obsidian4.Setting(containerEl).setName("List items to ignore").setDesc("List items which include listed words will not be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Element type for include").addDropdown((dropdown) => {
    ...
    if (this.plugin.settings.includeOnly != "none") {
      new import_obsidian4.Setting(containerEl).setName("Words to include").setClass("setting-indent").setDesc("Only elements specified in 'Element type for include' which include listed words will be displayed. Separate with a new line.").addTextArea((textArea) => {
      ...
      new import_obsidian4.Setting(containerEl).setName("Include the beginning part").setClass("setting-indent").setDesc("Specify whether to include the beginning parts of each daily note with no element to include ").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Exclusion ends at").setDesc("Excluding elements specified below ends at the selected type of elements. If you specified 'Element type for include' above, this value is ignored and excludeing elements ends at that type of elements.").addDropdown((dropdown) => {
    ...
    if (this.plugin.settings.showElements.heading) {
      new import_obsidian4.Setting(containerEl).setName("Headings to exclude").setDesc("Headings which include listed words and elements which belong to them will not be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    if (this.plugin.settings.showElements.link) {
      new import_obsidian4.Setting(containerEl).setName("Links to exclude").setDesc("Links which include listed words and elements which belong to them will not be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    if (this.plugin.settings.showElements.tag) {
      new import_obsidian4.Setting(containerEl).setName("Tags to exclude").setDesc("tags which include listed words and elements which belong to them will not be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    if (this.plugin.settings.showElements.listItems) {
      new import_obsidian4.Setting(containerEl).setName("List items to exclude").setDesc("List items which include listed words and elements which belong to them will not be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Icon").setClass("setting-indent").addDropdown((dropdown) => {
    ...
    if (this.plugin.settings.icon.note == "custom") {
      new import_obsidian4.Setting(containerEl).setName("Custom icon").setClass("setting-indent-2").setDesc("enter Lucide Icon name").addText((text) => {
    ...
    if (this.plugin.settings.showElements.heading) {
      ...
      new import_obsidian4.Setting(containerEl).setName("Prefix").setClass("setting-indent").addText((text) => {
        text.inputEl.setAttr("type", "string");
      ...
      if (this.plugin.settings.prefix.heading != "") {
        new import_obsidian4.Setting(containerEl).setName("Repeat heading prefix").setClass("setting-indent-2").addDropdown((dropdown) => {
      ...
      new import_obsidian4.Setting(containerEl).setName("Add indent").setClass("setting-indent").addToggle((toggle) => {
    ...
    if (this.plugin.settings.showElements.link) {
      ...
      new import_obsidian4.Setting(containerEl).setName("Add checkbox text to prefix").setDesc("add [ ] or [x]").setClass("setting-indent").addToggle((toggle) => {
...
var DailyNoteOutlinePlugin2 = class extends import_obsidian5.Plugin {
  constructor() {
    super(...arguments);
