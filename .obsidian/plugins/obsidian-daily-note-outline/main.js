      ...
      if (data[i].length > 0) {
        elementloop:
          for (let j = 0; j < data[i].length; j++) {
            ...
            switch (element) {
              case "link":
                (0, import_obsidian2.setIcon)(outlineTitle, "link");
                break;
              case "tag":
                (0, import_obsidian2.setIcon)(outlineTitle, "tag");
                break;
              case "listItems":
                (0, import_obsidian2.setIcon)(outlineTitle, "list");
                break;
              default:
                break;
            }
...
var DailyNoteOutlineSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName("Include future daily notes").setDesc("in backward search, include n days of future daily notes (default = 5)").addText((text) => {
      text.inputEl.setAttr("type", "number");
    ...
    new import_obsidian4.Setting(containerEl).setName("Onset date").setDesc("onset date in forward search (YYYY-MM-DD)").addText((text) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Show list items").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Show all root list items").addToggle((toggle) => {
    ...
    this.plugin.settings.headingLevel.forEach((value, index, arry) => {
      new import_obsidian4.Setting(containerEl).setName(`Level${index + 1}`).addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Tooltip preview direction").setDesc("specify the direction to display tooltip preview").addDropdown((dropdown) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Words to include").setDesc("Only elements specified in 'Include only' which include listed words will be displayed. Separate with a new line.").addTextArea((textArea) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Include the beginning part").setDesc("Specify whether to include the beginning parts of each daily note with no element to include ").addToggle((toggle) => {
    ...
    new import_obsidian4.Setting(containerEl).setName("Excluding ends at").setDesc("Excluding elements specified below ends at the selected type of elements. If you specified 'Element type for include' above, this value is ignored and excludeing elements ends at that type of elements.").addDropdown((dropdown) => {
